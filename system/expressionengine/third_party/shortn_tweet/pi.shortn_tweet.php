 ...
 * from Eric Barnes' original http://ericlbarnes.com/ee_tweet_this
 * Friday September 18, 2009
 * added bit.ly support
 * added variables for more flexible output (tagdata)
 * Updated to EE 2.0 by Jacob Russell, masugadesign.com/jacobrussell.net
 * 
 */
...
class Shortn_tweet {
  ...
  */
  function Shortn_tweet()
  {
    ...
    // Supposedly rendered unneccesary by EE2, commented out for testing.
  ...
  */
  ...
  function usage()
  {
    ...
    {exp:shortn_tweet title="{title}" url="{url_title_path=channel/item}" short_url="bit.ly"}
